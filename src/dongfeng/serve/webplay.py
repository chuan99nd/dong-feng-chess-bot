...
function renderTrainingDetail(run, metrics){
  ...
  document.getElementById("training-insights").innerHTML = [
    ...
    ic("value MSE",  lastV&&lastV.value_loss!=null?Number(lastV.value_loss).toFixed(4):"—", "", "tanh(v) vs outcome"),
    ic("value corr", lastV&&lastV.value_corr!=null?Number(lastV.value_corr).toFixed(3):"—",
                     lastV&&lastV.value_corr!=null?(lastV.value_corr>=0.3?"good":(lastV.value_corr<0.1?"warn":"")):"", "gate for MCTS head"),
